...
from authentication.views.twitter import TwitterAuthView, TwitterCompleteView
...
urlpatterns = [
    ...
    # Twitter
    path("twitter/login/", TwitterAuthView.as_view(), name="twitter_begin"),
    path("twitter/complete/", TwitterCompleteView.as_view(), name="twitter_complete"),
